...
# 2- from ModeApp.models import DataBase
...
# manage.py makemigrations ModeApp
# python manage.py sqlmigrate ModeApp 0001
...
# python manage.py makemigrations ModeApp
# python manage.py migrate ModeApp
